...
class Scene:
    ...
    def __init__(
        ...
        if os.path.exists(
        ...
        ) or os.path.exists(os.path.join(args.source_path, "colmap_sparse")):
            ...
            os.path.join(args.source_path, "cameras_sphere.npz")
        ):
            ...
            os.path.join(args.source_path, "poses_bounds.npy")
        ):
            ...
            print(
                "Found calibration_full.json, assuming Dynamic-360 data set!"
            )
        ...
        flow_list = (
            os.listdir(self.flow_dir) if os.path.exists(self.flow_dir) else []
        )
        flow_dirs_list = []
