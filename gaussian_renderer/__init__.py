...
def render(
    ...
    if scale_const is not None:
        ...
        opacity = (
            pc.get_opacity if d_opacity is None else pc.get_opacity + d_opacity
        )
    ...
    if render_motion:
        ...
        if colors_precomp is None:
            sh_features = (
                torch.cat(
                    [
                        pc.get_features[:, :1] + d_color[:, None],
                        pc.get_features[:, 1:],
                    ],
                    dim=1,
                )
...
def render_flow(
    ...
    **kwargs,
    ...
    gaussians_uvz_coor_at_cam2 = (
        gaussians_homogeneous_coor_t2 @ full_proj_transform
    )
    gaussians_uvz_coor_at_cam2 = (
        gaussians_uvz_coor_at_cam2[..., :3]
        / gaussians_uvz_coor_at_cam2[..., -1:]
    )
    ...
    gaussians_uvz_coor_at_cam1 = (
        gaussians_uvz_coor_at_cam1[..., :3]
        / gaussians_uvz_coor_at_cam1[..., -1:]
    )
