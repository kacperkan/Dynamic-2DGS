...
def zoom_image(image_path, region, region2, zoom_factor):
    ...
    image[
        x_pos - 100 + 20 : image.shape[1] - 100 + 20,
        0 + 20 + 50 : zoomed_height + 20 + 50,
    ] = zoomed_region
    cv2.rectangle(
        image,
        (0 + 20 + 50, x_pos - 100 + 20),
        (zoomed_height + 20 + 50, image.shape[1] - 100 + 20),
        (100, 100, 0),
        2,
    )
    ...
    # 使用指定的放大因子调整放大区域的尺寸
    zoomed_region2 = cv2.resize(
        zoomed_region2, (zoomed_width2, zoomed_height2)
    )

    # 在放大区域周围绘制边框
    cv2.rectangle(
        image, (x2, y2), (x2 + width2, y2 + height2), (100, 100, 0), 2
    )
    ...
    image[
        x_pos - 100 + 20 : image.shape[1] - 100 + 20,
        0 + 20 + 400 : zoomed_height + 20 + 400,
    ] = zoomed_region2
    cv2.rectangle(
        image,
        (0 + 20 + 400, x_pos - 100 + 20),
        (zoomed_height + 20 + 400, image.shape[1] - 100 + 20),
        (100, 100, 0),
        2,
    )
